...
public abstract class  Personaje {
	...
	private TRaza raza;
	protected int fuerza,inteligencia,vidaActual,vidaMaxima;
	...
	/**
	 * Modifica la fuerza del personaje, comprobando que está en el rango adecuado y si no lanzará la excepcion
	...
	/**
	 * Modifica la inteligencia del personaje, comprobando que está en el rango adecuado y si no lanzará la excepcion
	...
	/**
	 * Modifica la vida Máxima del personaje. No puede ser inferior a la vida actual , ni superar el límite máximo
	 * @param vidaMaxima
	 * @throws PersonajeException
	 */
